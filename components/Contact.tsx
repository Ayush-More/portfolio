...
const Contact = () => {
  ...
  return (
    <section id="contact" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-primary-500 hover:bg-primary-600 text-white font-medium py-4 px-6 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:scale-105"
              >
                Send Message
              </button>
            </form>
          ...
          >
            ...
            {/* Email Contact */}
            <div className="mb-8">
              <div className="flex items-center justify-center w-16 h-16 bg-primary-500 rounded-full mb-4">
            ...
            {/* What You Can Expect */}
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">What You Can Expect</h4>
              <div className="space-y-3">
                {expectations.map((expectation, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    <span className="text-gray-700">{expectation.text}</span>
                  </div>
                ))}
              </div>
            </div>
