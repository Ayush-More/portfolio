...
${formData.projectDetails}
        ...
        const mailtoLink = `mailto:ayushmore8652@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full text-lg py-4 font-semibold shadow-vibrant transition-all duration-300 ${
                  isSubmitting 
              ...
              {submitStatus === 'success' && (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-green-700 font-medium">Your email client should open with a pre-filled message. Please send it to complete your inquiry. I'll get back to you within 24 hours!</span>
                  </div>
                </motion.div>
              )}
              ...
              {submitStatus === 'error' && (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-red-700 font-medium">Failed to send message. Please try again or contact me directly at ayushmore8652@gmail.com</span>
                  </div>
                </motion.div>
              )}
            </form>
