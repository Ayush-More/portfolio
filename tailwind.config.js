...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-primary': '0 0 20px rgba(147, 51, 234, 0.3)',
        'glow-secondary': '0 0 20px rgba(16, 185, 129, 0.3)',
        'glow-accent': '0 0 20px rgba(249, 115, 22, 0.3)',
        'soft': '0 4px 6px rgba(0, 0, 0, 0.07), 0 10px 13px rgba(0, 0, 0, 0.06)',
        'medium': '0 10px 15px rgba(0, 0, 0, 0.1), 0 4px 6px rgba(0, 0, 0, 0.05)',
        'vibrant': '0 20px 25px rgba(0, 0, 0, 0.15), 0 8px 12px rgba(0, 0, 0, 0.06)',
      },
      animation: {
